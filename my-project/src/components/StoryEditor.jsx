...
// import { Edit, Save, X, RefreshCw, ArrowLeft, Book, FileText, ImageIcon, ChevronDown, ChevronUp } from 'lucide-react';
...
//         `${import.meta.env.VITE_BACKEND_DOMAIN}/api/v1/stories/update-story`,
//         updatePayload,
//         {
//           withCredentials: true,
//           headers: {
...
//       toast.error(err.response?.data?.message || "Failed to update story. Please try again.");
//     } finally {
//       setIsSaving(false);
//     }
//   };
