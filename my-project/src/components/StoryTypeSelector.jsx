...
//   return (
//     <div className="p-8">
//       <h2 className="text-2xl font-sans text-dark mb-6">Type of your story</h2>
...
const StoryTypeSelector = ({ onSelect }) => {
  ...
  // Story type options with icons and colors
  const storyTypes = [
    { 
      id: 'adventure', 
      label: 'Adventure', 
          ...
          {storyTypes.map((type) => (
            <div
              ...
              className={`p-4 rounded-xl border-2 cursor-pointer transition ${
                selectedType === type.id 
                  ? type.activeColor 
                  : `${type.bgColor} ${type.borderColor} hover:border-gray-400`
              }`}
              onClick={() => handleTypeSelect(type.id)}
            >
              <div className="flex flex-col items-center text-center">
