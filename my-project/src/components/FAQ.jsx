...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our platform uses a straightforward token system to create and save your personalized storybooks. Here's how it works: Every new user receives 10 tokens upon registration. Creating a new story requires 5 tokens, and saving a story costs an additional 2 tokens. Your token balance is displayed at the top of your dashboard for easy tracking. Different subscription tiers offer different token benefits."
    }
  ];
