...
//   const generatePrompt = async ({name,age,gender}) => {
//     // console.log("Hello from inside genratePrompt");
...
//     //   // formData.append('portrait', portraitImage); // Send the actual file, not base64
...
//     // } catch (error) {
//     //   console.error("Error generating prompt:", error.response.data);
//     //   alert("Failed to generate prompt. Please try again.");
//     //   setIsGenerating(false);
//     // }
//     try {
//       // The most direct way is still using FormData
...
//           <div>
//             <label htmlFor='appearance' className="block text-gray-700 font-medium mb-2">Age</label>
//             <input 
//               id='appearance'
//               type="text"
//               name="appearance"
...
//           <div>
//             <label htmlFor='appepersonalityarance' className="block text-gray-700 font-medium mb-2">Age</label>
//             <input 
//               id='personality'
//               type="text"
//               name="personality"
...
//           <div>
//             <label htmlFor='expressions' className="block text-gray-700 font-medium mb-2">Age</label>
//             <input 
//               id='expressions'
//               type="text"
//               name="expressions"
...
//           <button 
//             onClick={() => generatePrompt({name, age, gender})}
//             disabled={isGenerating || !portraitImage || !name || !age || !gender}
//             className={`w-full py-3 rounded-full font-bold flex items-center justify-center ${
//               (isGenerating || !portraitImage || !name || !age || !gender) 
...
//               className="w-full mt-3 py-3 rounded-full font-bold bg-primary-500 text-white hover:bg-primary-600 transition flex items-center justify-center"
//             >
